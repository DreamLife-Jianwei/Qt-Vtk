#ifndef BESTOPENGLWINDOW_H
#define BESTOPENGLWINDOW_H
 ...
 */
class BESTOpenGLWindow : public QOpenGLWindow
{
  Q_OBJECT
...
public:
  ...
  BESTOpenGLWindow(vtkGenericOpenGLRenderWindow* w,
  ...
  BESTOpenGLWindow(QOpenGLContext *shareContext,
    UpdateBehavior updateBehavior = NoPartialUpdate,
    QWindow *parent = Q_NULLPTR);
