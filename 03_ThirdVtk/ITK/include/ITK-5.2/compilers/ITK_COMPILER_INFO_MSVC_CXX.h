...
#    endif
  ...
  /* _MSC_VER = VVRR */
# define ITK_COMPILER_VERSION_MAJOR (_MSC_VER / 100)
# define ITK_COMPILER_VERSION_MINOR (_MSC_VER % 100)
# if defined(_MSC_FULL_VER)
#  if _MSC_VER >= 1400
    /* _MSC_FULL_VER = VVRRPPPPP */
#   define ITK_COMPILER_VERSION_PATCH (_MSC_FULL_VER % 100000)
#  else
    /* _MSC_FULL_VER = VVRRPPPP */
#   define ITK_COMPILER_VERSION_PATCH (_MSC_FULL_VER % 10000)
#  endif
# endif
# if defined(_MSC_BUILD)
#  define ITK_COMPILER_VERSION_TWEAK (_MSC_BUILD)
# endif
