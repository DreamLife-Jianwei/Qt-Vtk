...
#define VXL_INT_64_IS_LONGLONG 1
...
#define VXL_UNISTD_USLEEP_IS_VOID 1

/* true if <ieeefp.h> is available */
#define VXL_HAS_IEEEFP_H          
...
#define VXL_HAS_ALIGNED_MALLOC 1
